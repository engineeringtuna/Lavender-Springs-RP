...
Citizen.InvokeNative(0x1392105DA88BBFFB,GetHashKey("EXTERIOR_GRANDKORRIGANBOATDOCKED"), 2870.0, -1399.0, 0, 0);
--------- ### Problem IPLs ###
...
-----GAPTOOTH RIDGE MINE CAMP
RemoveImap(1312163721)
---GAPTOOTH RIDGE SMALLER CAMP
RemoveImap(2094371528)
----TESTING ZONE------
...
RequestImap(-1945901045)--talán új a unionnál
RequestImap(-186281506)--talán új a unionnál 2
RequestImap(1735860959) -- talán?
RequestImap(-1393565861) -- talán?
RequestImap(1251859782)--talán?
...
RemoveImap(2087181890) --RequestImap(2087181890)
...
RemoveImap(-1073832871)--BEECHERS HOPE ??
...
--RHODES BANK
--RequestImap(1721437778)--OFFICE

--RemoveImap(-661825463) -- RHODES BANK UP IN SAFE ROOM MISSING WALL
--RequestImap(1570711119) --SOMETHING ON THE SAFEWALL ROOM
--RequestImap(518127510)
--RequestImap(758684739)--HOLE INSIDE
--RemoveImap(828093818)

--RHODES SHERIFF
RequestImap(1817836578) --BOUNTY BOARD WITH LAMP
--RequestImap(-1982066530)
RequestImap(-1452926611)--KITÖRT FAL BEFALAZVA

--RHODES WOOL MILL
--RequestImap(-2008992782)--boxlods of cotton bales #2 TOGETHER
--RequestImap(-2023595928) -- lods of cotton bales #1 TOGETHER 
------------------RHODES BRAITHWAITH FARM------------------
--[[
RequestImap(979982112) --COTTON FIELDS #1
RequestImap(0x9E6E75D2) -- ???
RequestImap(-2015377340)--SMALL HOUSE INTERIOR
RequestImap(-1184151355)--LONG GRASS ON FIELDS
RequestImap(-282972514)--GRASS ON FIELDS #1
RequestImap(-362403544)-- DEAD COTTON ON FIELDS #2
RequestImap(-592147003) --GROWING GRASS ON FIELDS #3
RequestImap(-64632667) -- FIELDS #2 ADD GRASS LONG PART 1
RequestImap(-665583358) --FIELDS #2 ADD GRASS LONG PART 2
--RequestImap(-744260705) -- UNKNOWN
RequestImap(1128622296)-- CORN FIELD
--RequestImap(1424293412)--UNKNOWN
RequestImap(1557076971) --COTTON ON FIELDS 
RequestImap(1913538153) --WHEAT FIELDS #2
--RequestImap(24859476)--UNKNOWN
--RequestImap(979982112) --UNKNOWN
]]
-------EGYEB
--RequestImap(-567121002)--?? SOME CAMP ELEMENT  --CORDS  1763.205078125 -1907.2374267578 48.37467956543
...
RequestImap(-661825463) -- RHODES BANK UP IN SAFE ROOM MISSING WALL
