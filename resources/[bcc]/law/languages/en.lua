Locales['en'] = {
    ...
    --Boss Menu Translates
    bossmenu = "Boss Menu",
    hireemployeemenu = "Hire Employee Menu",
    fireemployeemenu = "Fire Employee Menu",
    --Hire Menu Translates
    nearbypeople = "Nearby People: ",
    hireselected = "Hire Selected Person",
    youhired = 'You hired the selected person',
    --Fire Menu Translates
    hiredpeople = "Hired People: ",
    fireselected = "Fire Selected Person",
    youfired = 'You fired the selected person',
    --Ledger Menu Translates
    ...
    bill = "Bill",
    billdescsyn = 'Bill the Citizen, allowing them to pay back later, to the society',
    billdesc = 'Bill the Citizen, taking the money from their bank account',
    fine = 'Fine',
    ...
    gaveabill = ' gave a bill of $',
    tothebank = ' at the bank located in ',
    to = ' to ',
    took = ' took ',
    of = ' of ',
    from = ' from ',
    ...
    invalid = ' invalid ',
    goback = "Go back",
    justgotpaid = "You just got paid $",
    clockon = "Clock on duty",
    clockoff = "Clock off duty",
    --Badge Translates
    up = "Move Badge Up",
